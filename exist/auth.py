...
class ExistAuth:
    ...
    def browser_authorize(self):
        ...
        server_config = {
            ...
            'server.ssl_certificate':'/Users/matt/Sites/python-exist/tests/files/certificate.pem',
            'server.ssl_private_key':'/Users/matt/Sites/python-exist/tests/files/privkey.pem',
